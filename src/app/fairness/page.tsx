...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "How BakiMate splits roommate bills fairly: guest-night weights, day-weighted utilities, proportional shares, and transparent rounding.",
  path: "/fairness",
  keywords: [
    "fair bill split",
    "day weighted split",
          ...
          <div className="mx-auto max-w-3xl space-y-5 text-slate-600 dark:text-slate-300 sm:space-y-6">
            ...
            <GlassPanel className="p-5 sm:p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed">
                ...
                leaves, BakiMate can record a clean &quot;buy-back&quot; so ownership
            ...
            <GlassPanel className="p-5 sm:p-6" id="calculations-disclaimer">
              ...
              <p className="mt-4 rounded-xl border border-[#FF6A6A]/25 bg-[#FF6A6A]/5 p-4 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                BakiMate helps your household track and agree on numbers. It
